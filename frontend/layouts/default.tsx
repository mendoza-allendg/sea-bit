...
export default function DefaultLayout({
  ...
  return (
    <div className="relative flex h-screen flex-col items-center justify-center overflow-x-hidden">
      <NextHead>
        <title>sea-bit</title>
      ...
      <main className="container relative mx-auto flex-grow px-6 lg:px-20 xl:px-36 2xl:px-44">
        {children}
      </main>
      <Footer />
    </div>
